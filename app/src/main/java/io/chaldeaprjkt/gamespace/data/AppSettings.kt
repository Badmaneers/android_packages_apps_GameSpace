...
class AppSettings @Inject constructor(private val context: Context) {
    ...
    var slidingPillLaneCount: Int
        get() = db.getInt(KEY_SLIDING_PILL_LANE_COUNT, 3)
        set(value) = db.edit().putInt(KEY_SLIDING_PILL_LANE_COUNT, value).apply()
    ...
    var slidingPillPosition: String
        get() = db.getString(KEY_SLIDING_PILL_POSITION, "top") ?: "top"
        set(value) = db.edit().putString(KEY_SLIDING_PILL_POSITION, value).apply()

    var slidingPillSize: String
        get() = db.getString(KEY_SLIDING_PILL_SIZE, "dynamic") ?: "dynamic"
        set(value) = db.edit().putString(KEY_SLIDING_PILL_SIZE, value).apply()

    var slidingPillCapsuleMode: Boolean
        get() = db.getBoolean(KEY_SLIDING_PILL_CAPSULE, true)
        set(value) = db.edit().putBoolean(KEY_SLIDING_PILL_CAPSULE, value).apply()

    var slidingPillCornerRadius: Int
        get() = db.getInt(KEY_SLIDING_PILL_CORNER_RADIUS, 20)
        set(value) = db.edit().putInt(KEY_SLIDING_PILL_CORNER_RADIUS, value).apply()
    ...
    var slidingPillOverflowMode: String
        get() = db.getString(KEY_SLIDING_PILL_OVERFLOW, "ellipsis") ?: "ellipsis"
        set(value) = db.edit().putString(KEY_SLIDING_PILL_OVERFLOW, value).apply()

    var slidingPillFontSize: Int
        get() = db.getInt(KEY_SLIDING_PILL_FONT_SIZE, 14)
        set(value) = db.edit().putInt(KEY_SLIDING_PILL_FONT_SIZE, value).apply()
    ...
    var slidingPillShowIcon: Boolean
        get() = db.getBoolean(KEY_SLIDING_PILL_SHOW_ICON, true)
        set(value) = db.edit().putBoolean(KEY_SLIDING_PILL_SHOW_ICON, value).apply()
    ...
    var slidingPillShowAvatar: Boolean
        get() = db.getBoolean(KEY_SLIDING_PILL_SHOW_AVATAR, true)
        set(value) = db.edit().putBoolean(KEY_SLIDING_PILL_SHOW_AVATAR, value).apply()

    var slidingPillShowCount: Boolean
        get() = db.getBoolean(KEY_SLIDING_PILL_SHOW_COUNT, true)
        set(value) = db.edit().putBoolean(KEY_SLIDING_PILL_SHOW_COUNT, value).apply()
    ...
    var slidingPillShadowStrength: Int
        get() = db.getInt(KEY_SLIDING_PILL_SHADOW_STRENGTH, 25)
        set(value) = db.edit().putInt(KEY_SLIDING_PILL_SHADOW_STRENGTH, value).apply()
    ...
    var slidingPillCustomOffset: Int
        get() = db.getInt(KEY_SLIDING_PILL_CUSTOM_OFFSET, 36)
        set(value) = db.edit().putInt(KEY_SLIDING_PILL_CUSTOM_OFFSET, value).apply()
    ...
    companion object {
        ...
        const val KEY_SLIDING_PILL_LANE_COUNT = "gamespace_sp_lane_count"
        const val KEY_SLIDING_PILL_ANIMATION = "gamespace_sp_animation"
        const val KEY_SLIDING_PILL_POSITION = "gamespace_sp_position"
        const val KEY_SLIDING_PILL_SIZE = "gamespace_sp_size"
        const val KEY_SLIDING_PILL_CAPSULE = "gamespace_sp_capsule"
        const val KEY_SLIDING_PILL_CORNER_RADIUS = "gamespace_sp_corner_radius"
        const val KEY_SLIDING_PILL_MAX_WIDTH = "gamespace_sp_max_width"
        const val KEY_SLIDING_PILL_MIN_WIDTH = "gamespace_sp_min_width"
        const val KEY_SLIDING_PILL_OVERFLOW = "gamespace_sp_overflow"
        const val KEY_SLIDING_PILL_FONT_SIZE = "gamespace_sp_font_size"
        ...
        const val KEY_SLIDING_PILL_SHOW_ICON = "gamespace_sp_show_icon"
        ...
        const val KEY_SLIDING_PILL_SHOW_AVATAR = "gamespace_sp_show_avatar"
        const val KEY_SLIDING_PILL_SHOW_COUNT = "gamespace_sp_show_count"
        ...
        const val KEY_SLIDING_PILL_SHADOW_STRENGTH = "gamespace_sp_shadow"
        ...
        const val KEY_SLIDING_PILL_CUSTOM_OFFSET = "gamespace_sp_custom_offset"
